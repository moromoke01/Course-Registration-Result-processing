            ...
            <div class="row mb-2" style="margin-top:30px;">
                ...
                <div class="col-sm-6 offset-4">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" id="studentform" action="Studform.php"  autocomplete="">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="matric" placeholder="Password">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="select" class="form-control" name="student_level" placeholder="Level">
                                </div>
                                <div class="form-group">
