            ...
            function getall(data) {
              ...
              function Allcourses(getall) {
                ...
                for ($y = 0; $y < $listCourses.length; $y++) {
                  if ($.inArray($listCourses[$y][1], $alredyregistered) != -1) {
                    $Check = true;
                  } else {
                    $Check = false;
                  }

                  $HtmlCode += '<tr data-code = "' + $listCourses[$y][1] + '">';
                  ...
                  $dis = $Check ? "disabled" : "";
                  $HtmlCode +=
                    "<td><button class='btn btn-success addButton' id='add' "+$dis+" >" +"<input type='text' value=''/>"+
                    $bt +
                    "</button></td><td>" +
                    $reg +
                    "</td></tr>";
                  ...
                  $(".addButton").click(function () {
                    $dscourse = $(this).closest("tr").data("code");
