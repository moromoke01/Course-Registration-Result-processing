            ...
            <div class="row">
                <div class="col-md-10 offset-2">
                    <div class="card" style="margin-top:20px;">
                        ...
                        $studentRecord = mysqli_query($conn, "SELECT * FROM student_table");
                        //$result = mysql_query($sql, $conn) or die(mysql_error());

                        if (mysqli_num_rows($studentRecord) > 0) {
                        ?>
                                ...
                                <table class='table  table-hover' id='dataTab'>
                                    <thead style="background:#FFFF99; color:black;">
                                        <tr>
                                            ...
                                            <?php while ($record = mysqli_fetch_array($studentRecord)) { ?>
                                             <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="viewFullDetails.php?id=<?php echo $newArray['id']; ?>" title="viewFullDetails" class="text-primary">
